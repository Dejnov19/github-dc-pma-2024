...
class MainActivity : AppCompatActivity() {
    ...
    fun PlayAgain(view: View?) {
        ...
        start()  // Restartuje hru včetně nového časovače a otázky
    ...
    private fun openDilog() {
        ...
        btnPlayAgain.setOnClickListener {
            PlayAgain(it)
            dialog.dismiss()  // Zavření dialogu po kliknutí na "Play Again"
        }

        btnBack.setOnClickListener {
            dialog.dismiss()  // Zavření dialogu po kliknutí na "Back"
            onBackPressed()
        }
